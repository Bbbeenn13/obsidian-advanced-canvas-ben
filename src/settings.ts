...
const SPENT_HOURS = 250
const RECEIVED_DONATIONS = 606
const HOURLY_RATE_GOAL = 15
...
export class AdvancedCanvasPluginSettingTab extends PluginSettingTab {
  ...
  private async createKofiBanner(containerEl: HTMLElement) {
    ...
    description.innerHTML = `
      Currently, Advanced Canvas has received <b>about ${RECEIVED_DONATIONS}£</b> in donations with a total of <b>about ${SPENT_HOURS} hours</b> spent on development. <br>
      <br>
      Please help me develop this plugin further by reaching the goal of <b>${HOURLY_RATE_GOAL}£/hour</b> ❤️
    `
    ...
    hourlyRate.textContent = `${(RECEIVED_DONATIONS / SPENT_HOURS).toString()}£/h`
