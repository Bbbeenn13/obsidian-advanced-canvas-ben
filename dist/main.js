...
// src/canvas-extensions/edge-style-shortcut-canvas-extension.ts
var EdgeStyleShortcutCanvasExtension = class extends CanvasExtension {
  isEnabled() {
    return "edgeStyleShortcutFeatureEnabled";
  }
  init() {
    this.plugin.addCommand({
  ...
  setEdgeStyleShortDashed(canvas) {
    var _a;
    const selectedEdges = [...canvas.selection].filter((item) => item.path !== void 0);
    for (const edge of selectedEdges) {
      const edgeData = edge.getData();
      const isShortDashed = ((_a = edgeData.styleAttributes) == null ? void 0 : _a.path) === "short-dashed";
      edge.setData({
        ...edgeData,
        styleAttributes: {
          ...edgeData.styleAttributes,
...
// src/canvas-extensions/node-footnote-canvas-extension.ts
var NodeFootnoteCanvasExtension = class extends CanvasExtension {
  isEnabled() {
    return "nodeFootnoteFeatureEnabled";
  }
  init() {
    this.plugin.registerEvent(this.plugin.app.workspace.on(
      "advanced-canvas:popup-menu-created",
    ...
    this.plugin.registerEvent(this.plugin.app.workspace.on(
      "advanced-canvas:node-added",
      (canvas, node) => this.renderFootnote(canvas, node)
    ));
    this.plugin.registerEvent(this.plugin.app.workspace.on(
      "advanced-canvas:node-changed",
      (canvas, node) => this.renderFootnote(canvas, node)
  ...
  onPopupMenuCreated(canvas) {
    ...
    const hasFootnote = selectedNodesData.some((nodeData) => nodeData.footnote);
    CanvasHelper.addPopupMenuOption(
      canvas,
      CanvasHelper.createPopupMenuOption({
        id: "node-footnote",
  ...
  startEditingFootnote(canvas) {
    ...
    let footnoteEl = node.nodeEl.querySelector(".ac-node-footnote");
    if (!footnoteEl) {
  ...
  setupEditing(canvas, node, footnoteEl, originalText) {
    ...
    const saveFootnote = () => {
      ...
      const newText = ((_a = footnoteEl.textContent) == null ? void 0 : _a.trim()) || "";
      node.setData({
        ...nodeData,
        footnote: newText || void 0
      });
      if (!newText) {
        footnoteEl.remove();
        (_b = node.nodeEl.querySelector(".ac-footnote-border-left")) == null ? void 0 : _b.remove();
        (_c = node.nodeEl.querySelector(".ac-footnote-border-right")) == null ? void 0 : _c.remove();
      }
      cleanup();
    };
  ...
  renderFootnote(_canvas, node) {
    var _a, _b, _c;
    const nodeData = node.getData();
    const footnoteText = nodeData.footnote;
    (_a = node.nodeEl.querySelector(".ac-node-footnote")) == null ? void 0 : _a.remove();
    (_b = node.nodeEl.querySelector(".ac-footnote-border-left")) == null ? void 0 : _b.remove();
    (_c = node.nodeEl.querySelector(".ac-footnote-border-right")) == null ? void 0 : _c.remove();
...
// src/canvas-extensions/quick-connect-canvas-extension.ts
var import_obsidian19 = require("obsidian");
var QuickConnectCanvasExtension = class extends CanvasExtension {
  constructor() {
    super(...arguments);
    this.selectionOrder = [];
  }
